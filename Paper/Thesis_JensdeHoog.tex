...
\textit{Navigation Stack} The navigation stack is a concept which calculates a path and velocity commands based on given information, such as odometry and data from rangefinders. An implementation is found in the ROS-framework and is realised using multiple nodes. One of these nodes is the 'move\textunderscore base'-node which has a major role in the system. Other nodes provide the odometry and transformation data, process the commands in order to drive the car and the 
