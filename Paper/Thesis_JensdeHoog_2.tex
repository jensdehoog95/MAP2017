...
%The navigation stack is tested by using an external virtual machine running Ubuntu 16.04. In order to send locations and goals to the navigation stack, the \emph{rviz}-environment--a visualisation tool in ROS--was used.
% on which the \emph{rviz}-environment--a visualisation tool in ROS--is used. This tool 
%The \emph{rviz}-environment--a visualisation tool in ROS--is used for sending positions and goals to the navigation stack.
